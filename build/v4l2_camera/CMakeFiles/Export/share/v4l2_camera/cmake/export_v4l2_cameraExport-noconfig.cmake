...
# Import target "v4l2_camera::camera_subscriber_node" for configuration ""
set_property(TARGET v4l2_camera::camera_subscriber_node APPEND PROPERTY IMPORTED_CONFIGURATIONS NOCONFIG)
set_target_properties(v4l2_camera::camera_subscriber_node PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/v4l2_camera/camera_subscriber_node"
  )

list(APPEND _IMPORT_CHECK_TARGETS v4l2_camera::camera_subscriber_node )
list(APPEND _IMPORT_CHECK_FILES_FOR_v4l2_camera::camera_subscriber_node "${_IMPORT_PREFIX}/lib/v4l2_camera/camera_subscriber_node" )
