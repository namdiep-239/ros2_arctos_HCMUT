...
def generate_launch_description():
    ...
    arctos_hw = get_package_share_directory("arctos_hardware_interface")
    arctos_moveit = get_package_share_directory("arctos_moveit_config")
    ...
    controllers_yaml = os.path.join(
        arctos_moveit, "config", "ros2_controllers.yaml"
    )
    ...
    return LaunchDescription([
        LogInfo(msg=["Launching Arctos Hardware Test (ROS2 Control Clean Version)..."]),
        control_node,
        robot_state_pub,
        js_broadcaster,
        delay_arm,
