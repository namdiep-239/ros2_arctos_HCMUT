...
Remember to source the ros2_ws before running moveit_setup_assistant, then select artos.xacro in the arctos_description/urdf folder. Follow the steps in the tutorial and generate the entire new moveit_config package. Merge necessary changes.
